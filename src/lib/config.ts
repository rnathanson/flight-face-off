...
export async function loadConfig() {
  try {
    ...
    const validated = {
      ...
      pc24Ownership: {
        defaultAircraftCost: Number(parsed.pc24Ownership?.defaultAircraftCost ?? DEFAULT_CONFIG.pc24Ownership.defaultAircraftCost),
        // Force default down payment to 100% regardless of stored value
        defaultDownPaymentPercent: DEFAULT_CONFIG.pc24Ownership.defaultDownPaymentPercent,
        defaultInterestRate: Number(parsed.pc24Ownership?.defaultInterestRate ?? DEFAULT_CONFIG.pc24Ownership.defaultInterestRate),
        defaultLoanTermYears: Number(parsed.pc24Ownership?.defaultLoanTermYears ?? DEFAULT_CONFIG.pc24Ownership.defaultLoanTermYears),
        defaultResalePercent: Number(parsed.pc24Ownership?.defaultResalePercent ?? DEFAULT_CONFIG.pc24Ownership.defaultResalePercent),
        hangarCost: Number(parsed.pc24Ownership?.hangarCost ?? DEFAULT_CONFIG.pc24Ownership.hangarCost),
        insuranceAnnual: Number(parsed.pc24Ownership?.insuranceAnnual ?? DEFAULT_CONFIG.pc24Ownership.insuranceAnnual),
        managementFee: Number(parsed.pc24Ownership?.managementFee ?? DEFAULT_CONFIG.pc24Ownership.managementFee),
        subscriptions: Number(parsed.pc24Ownership?.subscriptions ?? DEFAULT_CONFIG.pc24Ownership.subscriptions),
        cleaningMonthly: Number(parsed.pc24Ownership?.cleaningMonthly ?? DEFAULT_CONFIG.pc24Ownership.cleaningMonthly),
        pilotServicesAnnual: Number(parsed.pc24Ownership?.pilotServicesAnnual ?? DEFAULT_CONFIG.pc24Ownership.pilotServicesAnnual),
        pilotPoolContribution: Number(parsed.pc24Ownership?.pilotPoolContribution ?? DEFAULT_CONFIG.pc24Ownership.pilotPoolContribution),
        jetstreamHourly: Number(parsed.pc24Ownership?.jetstreamHourly ?? DEFAULT_CONFIG.pc24Ownership.jetstreamHourly),
        fuelBurnPerHour: Number(parsed.pc24Ownership?.fuelBurnPerHour ?? DEFAULT_CONFIG.pc24Ownership.fuelBurnPerHour),
        fuelPricePerGallon: Number(parsed.pc24Ownership?.fuelPricePerGallon ?? DEFAULT_CONFIG.pc24Ownership.fuelPricePerGallon),
      pilotServicesHourly: Number(parsed.pc24Ownership?.pilotServicesHourly ?? DEFAULT_CONFIG.pc24Ownership.pilotServicesHourly),
      typeRatingInitial: Number(parsed.pc24Ownership?.typeRatingInitial ?? DEFAULT_CONFIG.pc24Ownership.typeRatingInitial),
      typeRatingRecurrent: Number(parsed.pc24Ownership?.typeRatingRecurrent ?? DEFAULT_CONFIG.pc24Ownership.typeRatingRecurrent),
      defaultOwnerHours: Number(parsed.pc24Ownership?.defaultOwnerHours ?? DEFAULT_CONFIG.pc24Ownership.defaultOwnerHours),
    },
    jetstreamPackages: {
      '2yr-300hrs': {
      ...
      ownersFleetOwnership: {
        ...
        pc24JetstreamHourly: Number(parsed.ownersFleetOwnership?.pc24JetstreamHourly ?? DEFAULT_CONFIG.ownersFleetOwnership.pc24JetstreamHourly),
        pc24FuelBurnPerHour: Number(parsed.ownersFleetOwnership?.pc24FuelBurnPerHour ?? DEFAULT_CONFIG.ownersFleetOwnership.pc24FuelBurnPerHour),
        pc24FuelPricePerGallon: Number(parsed.ownersFleetOwnership?.pc24FuelPricePerGallon ?? DEFAULT_CONFIG.ownersFleetOwnership.pc24FuelPricePerGallon),
        pc24PilotServicesHourly: Number(parsed.ownersFleetOwnership?.pc24PilotServicesHourly ?? DEFAULT_CONFIG.ownersFleetOwnership.pc24PilotServicesHourly),
